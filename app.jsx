...
/* ============================================================================
   SEED DATA — replace with [] for a blank slate
   ========================================================================= */
...
export default function App() {
  // In-memory only: artifacts can't use localStorage. Outside an artifact,
  // swap this initializer for one that reads localStorage, and add a
  // useEffect below that writes `tasks` to localStorage on every change.
